...
from PyQt6.QtWidgets import (QMainWindow, QWidget, QVBoxLayout, QHBoxLayout,
                           QGridLayout, QFrame, QComboBox, QGroupBox,
                           QPushButton, QLabel, QLineEdit, QCheckBox)
from PyQt6.QtCore import Qt, QTimer
from PyQt6.QtGui import QFont, QPixmap, QIcon, QDoubleValidator

from .widgets import LabeledKnob, WaveformSelector, PianoKeys
...
class MurnauUI(QMainWindow):
    ...
    def _create_filter_controls(self, layout):
        ...
        self.cutoff_knob_L = LabeledKnob("Cutoff", 20, 20000, 2000, is_log=True, midi_cc=74)
        ...
        self.cutoff_knob_R = LabeledKnob("Cutoff", 20, 20000, 2000, is_log=True, midi_cc=75)
