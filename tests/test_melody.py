...
class TestPlayMelody:
    ...
    def test_play_melody_complete_flow(self, mock_print, mock_client_class, mock_sleep, 
    ...
    @patch('src.murnau.synth.melody.play_note')
    @patch('pythonosc.udp_client.SimpleUDPClient')
    def test_play_melody_with_custom_data(self, mock_client_class, mock_play_note, mock_init_synth):
    ...
    @patch('src.murnau.synth.melody.play_note')
    @patch('pythonosc.udp_client.SimpleUDPClient')
    def test_play_melody_with_init_synth_exception(self, mock_client_class, mock_play_note, mock_init_synth):
    ...
    @patch('src.murnau.synth.melody.midi_to_freq')
    @patch('pythonosc.udp_client.SimpleUDPClient')
    def test_play_melody_with_play_note_exception(self, mock_client_class, mock_midi_to_freq, 
...
class TestMelodyData:
    ...
    def test_melody_structure(self):
        ...
        with patch('src.murnau.synth.melody.play_note') as mock_play_note, \
             patch('src.murnau.synth.melody.init_synth'), \
             patch('src.murnau.synth.melody.midi_to_freq') as mock_midi_to_freq, \
             patch('time.sleep'), \
             patch('pythonosc.udp_client.SimpleUDPClient'):
