...
class TestMurnauUICore:
    ...
    def test_init_osc_settings(self, mock_super_init, mock_timer, mock_midi, mock_udp_client):
        ...
        with patch.object(MurnauUI, 'init_ui'), \
             patch.object(MurnauUI, 'init_midi'), \
             patch.object(MurnauUI, 'init_parameters'), \
             patch.object(MurnauUI, 'show'), \
             patch.object(MurnauUI, '_animate_ui_elements'):
...
class TestMurnauUIIntegrationSafe:
    ...
    def test_initialization_flow(self, mock_midi, mock_udp_client):
        ...
        with patch.object(MurnauUI, 'init_ui'), \
             ...
             patch.object(MurnauUI, 'show'), \
             patch.object(MurnauUI, '_animate_ui_elements'), \
             patch.object(MurnauUI, 'setFocus'):
